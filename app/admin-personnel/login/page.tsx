...
export default function AdminPersonnelLoginPage() {
  ...
  return (
    <div className="min-h-screen relative w-full overflow-hidden bg-gradient-to-br from-pink-100 via-fuchsia-50 to-purple-100 dark:from-[#0a0e1a] dark:via-[#1a0f1a] dark:to-[#150a1a] flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 w-full h-full pointer-events-none overflow-hidden z-[1]">
        ...
        <div className="block dark:hidden w-full h-full relative">
          {/* Sun with pink/purple glow */}
          <div className="absolute top-10 right-20 w-24 h-24 bg-pink-400 rounded-full shadow-[0_0_60px_#f472b6] animate-pulse"></div>
          
          {/* Ocean Waves with pink/purple tints */}
          {waves.map((wave) => (
            <div
              key={wave.id}
            ...
            >
              <svg viewBox="0 0 300 80" fill="none" style={{ width: '100%', height: '100%' }}>
                <path d="M0 40 Q 75 20, 150 40 T 300 40 L 300 80 L 0 80 Z" fill="rgba(244, 114, 182, 0.2)" />
                <path d="M0 45 Q 75 30, 150 45 T 300 45 L 300 80 L 0 80 Z" fill="rgba(217, 70, 239, 0.15)" />
              </svg>
            </div>
          ))}
          ...
          {/* Beach Sand with pink tone */}
          <div className="absolute bottom-0 left-0 w-full h-24 bg-gradient-to-t from-pink-200 via-fuchsia-100 to-transparent"></div>
        </div>

        {/* DARK MODE: NIGHT BEACH WITH STARS */}
        <div className="hidden dark:block w-full h-full relative">
          {/* Moon with purple glow */}
          <div className="absolute top-16 right-24 w-20 h-20 bg-purple-200 rounded-full shadow-[0_0_80px_#e9d5ff] opacity-90">
            <div className="absolute top-2 right-3 w-4 h-4 bg-purple-300 rounded-full opacity-40"></div>
            <div className="absolute top-6 right-8 w-3 h-3 bg-purple-300 rounded-full opacity-30"></div>
          </div>
          ...
          {stars.map((star) => (
            ...
            >
              <svg width={`${12 * star.scale}`} height={`${12 * star.scale}`} viewBox="0 0 24 24" fill="#e9d5ff">
                <path d="M12 2 L14.5 9.5 L22 12 L14.5 14.5 L12 22 L9.5 14.5 L2 12 L9.5 9.5 Z" />
              </svg>
            </div>
          ))}
          
          {/* Shooting Stars with purple trails */}
          {shootingStars.map((star) => (
            ...
            >
              <svg width="60" height="3" viewBox="0 0 60 3" fill="none">
                ...
                <circle cx="58" cy="1.5" r="2" fill="#e9d5ff" />
              </svg>
            </div>
          ))}
          ...
          {/* Dark Ocean Waves with purple tint */}
          <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-purple-950 via-fuchsia-950/50 to-transparent opacity-60">
            <svg className="absolute bottom-0 w-full h-full opacity-30" viewBox="0 0 1200 100" preserveAspectRatio="none">
              <path d="M0,50 Q300,20 600,50 T1200,50 L1200,100 L0,100 Z" fill="rgba(112, 26, 117, 0.3)" />
            </svg>
          </div>
          
          {/* Night Beach Sand with purple tone */}
          <div className="absolute bottom-0 left-0 w-full h-20 bg-gradient-to-t from-purple-950 via-fuchsia-900/50 to-transparent opacity-50"></div>
        </div>
      </div>

      {/* Background Glows with personnel colors */}
      <div className="absolute inset-0 pointer-events-none z-[2]">
        <div className="absolute top-1/4 left-10 w-80 h-80 bg-pink-400/20 dark:bg-fuchsia-600/10 blur-[120px] rounded-full animate-pulse"></div>
