...
export async function POST(request: NextRequest) {
  ...
  if (!authResult.success || !authResult.admin || authResult.admin.role !== "super_admin") {
    return createAdminUnauthorizedResponse(authResult.error || "Super Admin access required")
  }

  try {
    console.log("[MYT] Starting retroactive student code assignment")
