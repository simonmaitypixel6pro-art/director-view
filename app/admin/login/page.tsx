...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen relative w-full overflow-hidden bg-gradient-to-br from-orange-100 via-red-50 to-yellow-100 dark:from-[#0a0e1a] dark:via-[#1a0f0f] dark:to-[#1a1510] flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 w-full h-full pointer-events-none overflow-hidden z-[1]">
        ...
        <div className="block dark:hidden w-full h-full relative">
          {/* Sun with warm glow */}
          <div className="absolute top-10 right-20 w-24 h-24 bg-orange-400 rounded-full shadow-[0_0_60px_#fb923c] animate-pulse"></div>
          ...
          {waves.map((wave) => (
            ...
            >
              <svg viewBox="0 0 300 80" fill="none" style={{ width: '100%', height: '100%' }}>
                <path d="M0 40 Q 75 20, 150 40 T 300 40 L 300 80 L 0 80 Z" fill="rgba(251, 146, 60, 0.2)" />
                <path d="M0 45 Q 75 30, 150 45 T 300 45 L 300 80 L 0 80 Z" fill="rgba(249, 115, 22, 0.15)" />
              </svg>
            </div>
          ))}
          ...
          {/* Beach Sand with warm tone */}
          <div className="absolute bottom-0 left-0 w-full h-24 bg-gradient-to-t from-orange-200 via-yellow-100 to-transparent"></div>
        </div>

        {/* DARK MODE: NIGHT BEACH WITH STARS */}
        <div className="hidden dark:block w-full h-full relative">
          {/* Moon with warm glow */}
          <div className="absolute top-16 right-24 w-20 h-20 bg-orange-200 rounded-full shadow-[0_0_80px_#fed7aa] opacity-90">
            <div className="absolute top-2 right-3 w-4 h-4 bg-orange-300 rounded-full opacity-40"></div>
            <div className="absolute top-6 right-8 w-3 h-3 bg-orange-300 rounded-full opacity-30"></div>
          </div>
          ...
          {stars.map((star) => (
            ...
            >
              <svg width={`${12 * star.scale}`} height={`${12 * star.scale}`} viewBox="0 0 24 24" fill="#fed7aa">
                <path d="M12 2 L14.5 9.5 L22 12 L14.5 14.5 L12 22 L9.5 14.5 L2 12 L9.5 9.5 Z" />
              </svg>
            </div>
          ))}
          
          {/* Shooting Stars with warm trails */}
              ...
              <svg width="60" height="3" viewBox="0 0 60 3" fill="none">
                <defs>
                  <linearGradient id={`grad-${star.id}`} x1="0%" y1="0%" x2="100%" y2="0%">
                    ...
                    <stop offset="50%" stopColor="#fed7aa" stopOpacity="1" />
                    <stop offset="100%" stopColor="#fb923c" stopOpacity="0.8" />
                  </linearGradient>
                </defs>
                <rect width="60" height="3" fill={`url(#grad-${star.id})`} />
                <circle cx="58" cy="1.5" r="2" fill="#fed7aa" />
              </svg>
            </div>
          ))}
          ...
          {palmTrees.slice(0, 5).map((tree) => (
            ...
            >
              <svg viewBox="0 0 100 150" fill="none" style={{ width: '100%', height: '100%' }}>
                <rect x="45" y="60" width="10" height="90" fill="#2d1b1b" rx="2" />
                <ellipse cx="50" cy="30" rx="45" ry="15" fill="#3d2020" transform="rotate(-30 50 30)" />
                <ellipse cx="50" cy="30" rx="45" ry="15" fill="#3d2020" transform="rotate(30 50 30)" />
                <ellipse cx="50" cy="30" rx="45" ry="15" fill="#4d2525" transform="rotate(0 50 30)" />
              </svg>
            </div>
          ))}
          
          {/* Dark Ocean Waves with red tint */}
          <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-red-950 via-orange-950/50 to-transparent opacity-60">
            <svg className="absolute bottom-0 w-full h-full opacity-30" viewBox="0 0 1200 100" preserveAspectRatio="none">
              <path d="M0,50 Q300,20 600,50 T1200,50 L1200,100 L0,100 Z" fill="rgba(127, 29, 29, 0.3)" />
            </svg>
          </div>
          
          {/* Night Beach Sand with warm tone */}
          <div className="absolute bottom-0 left-0 w-full h-20 bg-gradient-to-t from-orange-950 via-red-900/50 to-transparent opacity-50"></div>
        </div>
      </div>

      {/* Background Glows with admin colors */}
      <div className="absolute inset-0 pointer-events-none z-[2]">
        <div className="absolute top-1/4 left-10 w-80 h-80 bg-orange-400/20 dark:bg-red-600/10 blur-[120px] rounded-full animate-pulse"></div>
        <div className="absolute bottom-1/4 right-10 w-80 h-80 bg-red-400/20 dark:bg-orange-600/10 blur-[120px] rounded-full animate-pulse"></div>
      </div>
