...
export default function TechnicalPeonLeavesPage() {
  ...
  useEffect(() => {
    const adminAuth = localStorage.getItem("technicalTeamAuth")
    const adminDataStr = localStorage.getItem("technicalTeamData")
  ...
  const fetchLeaves = async () => {
    try {
      setRefreshing(true)
      const response = await fetch(`/api/admin/leaves/pending?role=technical`)
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-black text-slate-900 dark:text-gray-100 transition-colors duration-500">
      ...
      >
        ...
        <motion.div variants={itemVariants}>
            <Card className="bg-emerald-50/50 dark:bg-emerald-950/10 border-emerald-200 dark:border-emerald-900/50">
                <CardContent className="p-6 flex items-start gap-4">
                    <div className="p-3 bg-emerald-100 dark:bg-emerald-900/30 rounded-full">
                        <Briefcase className="w-6 h-6 text-emerald-600 dark:text-emerald-400" />
                    </div>
                    <div>
                        <h3 className="font-semibold text-emerald-900 dark:text-emerald-200 mb-1">Staff Management Protocol</h3>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex gap-2 mt-1">
                                                <Badge variant="secondary" className="text-[10px] h-5 px-1.5 bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400">Peon</Badge>
