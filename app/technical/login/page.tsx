...
export default function TechnicalTeamLogin() {
  ...
  return (
    <div className="min-h-screen relative w-full overflow-hidden bg-gradient-to-br from-emerald-100 via-teal-50 to-green-100 dark:from-[#0a0e1a] dark:via-[#0f1a15] dark:to-[#0a1a12] flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 w-full h-full pointer-events-none overflow-hidden z-[1]">
        ...
        <div className="block dark:hidden w-full h-full relative">
          {/* Sun with green/teal glow */}
          <div className="absolute top-10 right-20 w-24 h-24 bg-emerald-400 rounded-full shadow-[0_0_60px_#34d399] animate-pulse"></div>
          
          {/* Ocean Waves with emerald/teal tints */}
          {waves.map((wave) => (
            <div
              key={wave.id}
            ...
            >
              <svg viewBox="0 0 300 80" fill="none" style={{ width: '100%', height: '100%' }}>
                <path d="M0 40 Q 75 20, 150 40 T 300 40 L 300 80 L 0 80 Z" fill="rgba(16, 185, 129, 0.2)" />
                <path d="M0 45 Q 75 30, 150 45 T 300 45 L 300 80 L 0 80 Z" fill="rgba(20, 184, 166, 0.15)" />
              </svg>
            </div>
          ))}
          ...
          {/* Beach Sand with green tone */}
          <div className="absolute bottom-0 left-0 w-full h-24 bg-gradient-to-t from-emerald-200 via-teal-100 to-transparent"></div>
        </div>

        {/* DARK MODE: NIGHT BEACH WITH STARS */}
        <div className="hidden dark:block w-full h-full relative">
          {/* Moon with green/teal glow */}
          <div className="absolute top-16 right-24 w-20 h-20 bg-teal-200 rounded-full shadow-[0_0_80px_#99f6e4] opacity-90">
            <div className="absolute top-2 right-3 w-4 h-4 bg-teal-300 rounded-full opacity-40"></div>
            <div className="absolute top-6 right-8 w-3 h-3 bg-teal-300 rounded-full opacity-30"></div>
          </div>
          ...
          {stars.map((star) => (
            ...
            >
              <svg width={`${12 * star.scale}`} height={`${12 * star.scale}`} viewBox="0 0 24 24" fill="#99f6e4">
                <path d="M12 2 L14.5 9.5 L22 12 L14.5 14.5 L12 22 L9.5 14.5 L2 12 L9.5 9.5 Z" />
              </svg>
            </div>
          ))}
          
          {/* Shooting Stars with teal trails */}
          {shootingStars.map((star) => (
            ...
            >
              <svg width="60" height="3" viewBox="0 0 60 3" fill="none">
                ...
                <circle cx="58" cy="1.5" r="2" fill="#99f6e4" />
              </svg>
            </div>
          ))}
          ...
          {palmTrees.slice(0, 5).map((tree) => (
            ...
            >
              <svg viewBox="0 0 100 150" fill="none" style={{ width: '100%', height: '100%' }}>
                <rect x="45" y="60" width="10" height="90" fill="#1b2d2d" rx="2" />
                <ellipse cx="50" cy="30" rx="45" ry="15" fill="#203d3d" transform="rotate(-30 50 30)" />
                <ellipse cx="50" cy="30" rx="45" ry="15" fill="#203d3d" transform="rotate(30 50 30)" />
                <ellipse cx="50" cy="30" rx="45" ry="15" fill="#254d4d" transform="rotate(0 50 30)" />
              </svg>
            </div>
          ))}
          
          {/* Dark Ocean Waves with teal tint */}
          <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-teal-950 via-emerald-950/50 to-transparent opacity-60">
            <svg className="absolute bottom-0 w-full h-full opacity-30" viewBox="0 0 1200 100" preserveAspectRatio="none">
              <path d="M0,50 Q300,20 600,50 T1200,50 L1200,100 L0,100 Z" fill="rgba(19, 78, 74, 0.3)" />
            </svg>
          </div>
          
          {/* Night Beach Sand with teal tone */}
          <div className="absolute bottom-0 left-0 w-full h-20 bg-gradient-to-t from-teal-950 via-emerald-900/50 to-transparent opacity-50"></div>
        </div>
      </div>

      {/* Background Glows with technical colors */}
      <div className="absolute inset-0 pointer-events-none z-[2]">
        <div className="absolute top-1/4 left-10 w-80 h-80 bg-emerald-400/20 dark:bg-emerald-600/10 blur-[120px] rounded-full animate-pulse"></div>
        <div className="absolute bottom-1/4 right-10 w-80 h-80 bg-teal-400/20 dark:bg-teal-600/10 blur-[120px] rounded-full animate-pulse"></div>
      </div>
