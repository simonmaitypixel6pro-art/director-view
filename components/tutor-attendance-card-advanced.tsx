...
export function TutorAttendanceCardAdvanced({ tutorId }: { tutorId: number }) {
  ...
  const fetchAttendanceStatus = useCallback(async () => {
    try {
      ...
      const response = await fetch(`/api/tutor/attendance/status?${params.toString()}`)
          ...
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <CardTitle className="text-lg flex items-center gap-2">
                ...
                Advanced Self Attendance
              </CardTitle>
              <CardDescription>Multi-campus location-based marking with device security</CardDescription>
            </div>
